        ...
        private void SeedProducts(StoreContext context)
        {
            var products = new List<Product>()
            {
                new Product()
                {
                    ...
                    Category = context.Categories.Where(c=> c.Name == "BooksConsumptives").FirstOrDefault(),
                    Price = 20,
                ...
                new Product()
                {
                    ...
                    Category = context.Categories.Where(c=> c.Name == "ComputersPeriphery").FirstOrDefault(),
                    Price = 4999,
                ...
                new Product()
                {
                    Name = "Laundry",
                    Country = context.Countries.Where(c=> c.Name == "Hong Kong").FirstOrDefault(),
                    Category = context.Categories.Where(c=> c.Name == "ElectricAppliances").FirstOrDefault(),
                    Price =200,
                ...
                new Product()
                {
                    Name = "Stool",
                    Country = context.Countries.Where(c=> c.Name == "Hong Kong").FirstOrDefault(),
                    Category = context.Categories.Where(c=> c.Name == "HomeFurniture").FirstOrDefault(),
                    Price = 39.99m,
                ...
                new Product()
                {
                    Name = "Caterpillar",
                    Country = context.Countries.Where(c=> c.Name == "Hong Kong").FirstOrDefault(),
                    Category = context.Categories.Where(c=> c.Name == "MobileDevices").FirstOrDefault(),
                    Price = 209.99m,
                ...
                new Product()
                {
                    Name = "Nikon",
                    Country = context.Countries.Where(c=> c.Name == "Hong Kong").FirstOrDefault(),
                    Category = context.Categories.Where(c=> c.Name == "PhotoVideo").FirstOrDefault(),
                    Price = 1449.99m,
                ...
                new Product()
                {
                    Name = "Basket ball",
                    Country = context.Countries.Where(c=> c.Name == "Hong Kong").FirstOrDefault(),
                    Category = context.Categories.Where(c=> c.Name == "Sports").FirstOrDefault(),
                    Price = 59.99m,
